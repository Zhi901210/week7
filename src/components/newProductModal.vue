          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="mb-2">
                ...
                <img class="img-fluid" :src="newProductData.imageUrl" alt="" />
              </div>
              <div v-if="!newProductData.imagesUrl">
                <button
                  class="btn btn-outline-danger btn-sm d-block w-100"
                  @click="newProductData.imageUrl = []"
                >
                  刪除圖片
                </button>
              </div>
            ...
            <div class="col-sm-8">
              ...
              <div class="row">
                <div class="mb-3 col-md-6">
                  ...
                  <input
                    ...
                    class="form-control"
                    placeholder="請輸入原價"
                    v-model="newProductData.origin_price"
                  />
                </div>
                <div class="mb-3 col-md-6">
              ...
              <div class="mb-3">
                ...
                <textarea
                  ...
                  class="form-control"
                  placeholder="請輸入說明內容"
                  v-model="newProductData.content"
                >
                </textarea>
              </div>
              <div class="mb-3">
                <div class="form-check">
                  <input
                    id="is_enabled"
                    v-model="newProductData.is_enabled"
...
export default {
  ...
  methods: {
    ...
    newProduct () {
      this.postNewProductData = { ...this.newProductData }
      this.$http
        .post(`${VITE_APP_URL}/v2/api/${VITE_APP_PATH}/admin/product`, {
          data: this.postNewProductData
        })
        .then((res) => {
  ...
  mounted () {
    this.newProductModal = new Modal(this.$refs.newProductModal)
  }
}
</script>
